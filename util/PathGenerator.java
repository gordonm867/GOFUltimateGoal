...
public class PathGenerator implements Callable<ArrayList<Point[]>> {
    ...
    public ArrayList<Point[]> getPath(int rings) {
        ...
        if(rings == 0) {
            path.add(new Line(new Point(blue ? Globals.START_X : -Globals.START_X, Globals.START_Y), new Point(-1.35 + (4.0/12), 0, 86))); // Start-power shots
            ...
            path.add(new Line(new Point(-3.5, -0.1), new Point(0, -0.3, 90))); // Wobble drop off-shoot
            ...
            path.add(new Line(new Point(0, -0.3), new Point(0, 0, 90))); // Shoot-park
        }
        else if(rings == 1) {
            path.add(new Line(new Point(blue ? Globals.START_X : -Globals.START_X, Globals.START_Y), new Point(-1.35 + (4.0/12), 0, 90)));
            ...
            path.add(new Line(new Point(-3 - (2.0/12), -1.8), new Point(-3.55, -2.33, 90)));
            path.add(new Line(new Point(-3.55, -2.73), new Point(-2.85, -1, 91), obstacles));
            ...
            path.add(new Line(new Point(blue ? Globals.START_X : -Globals.START_X, Globals.START_Y), new Point(-1.35 + (4.0/12), 0, 90))); // Start-power shots
            ...
            path.add(new Line(new Point(-4.16, -2.58), new Point(-3.12 - (-0.5/12), -3.15, 90), obstacles));
            path.add(new Line(new Point(-3.12 - (-0.5/12), -3.15), new Point(-4.5, 3, -135), obstacles)); // Wobble pickup-wobble drop off
